...
class KalmanEstimator(Estimator):
    """
    Реализация оценки скорости при помощи фильтра Калмана
    """
    ...
    def __init__(self, Q: np.array, R: np.array, H: np.array, system: StateSpace):
        ...
        :param Q: Ковариационная матрица процесса - диагональная, размер соответствует количеству состояний
    ...
    def estimate(self, t, x, u) -> np.array:
        ...
        :param u: Вектор значений управления
        ...
        # Здесь всё почти как на https://en.wikipedia.org/wiki/Kalman_filter
